...
- [FAQs](#faqs)
    - [Q1: Why can I not see all conversations in my Inbox?](#q1-why-can-i-not-see-all-conversations-in-my-inbox)
    - [Q2: Why do my LinkedIn connection requests not appear in the Sent folder?](#q2-why-do-my-linkedin-connection-requests-not-appear-in-the-sent-folder)
    - [Q3: How do I know if a tag was applied by AI or manually?](#q3-how-do-i-know-if-a-tag-was-applied-by-ai-or-manually)
    - [Q4: Can I edit or delete an AI-generated draft before sending?](#q4-can-i-edit-or-delete-an-ai-generated-draft-before-sending)
    - [Q5: Why are my file attachments sent as links instead of direct attachments?](#q5-why-are-my-file-attachments-sent-as-links-instead-of-direct-attachments)
