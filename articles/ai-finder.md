...
> **Tip:** You can revisit your previous searches anytime through **Search History**.
...
| Filter | Description |
|--------|-------------|
| **Function** | Professional function or department (Sales, Engineering, Marketing, HR, Finance, etc.) |
| **Current Title** | Specific job titles or roles. Supports multiple languages based on region |
| **Past Title** | Roles held previously in career history |
| **Years at Current Company** | Tenure at current employer (Less than 1 year, 1–2 years, 3–5 years, 6–10 years, More than 10 years) |
| **Years in Current Position** | Time spent in current role across all employers |
| **Years of Experience** | Total years of professional experience |
| **Region** | Geographic location (cities, states, countries, regions) |
| **School** | Educational institutions attended |
| **Current Company** | Organizations where contacts are currently employed |
| **Past Company** | Organizations where contacts have previously worked |
| **Company Headcount** | Size of current employer (1–10, 11–50, 51–200, 201–500, 501–1,000, 1,001–5,000, 5,001–10,000, 10,001+) |
| **Company Type** | Organization category (Public Company, Privately Held, Non-Profit, Educational Institution, etc.) |
| **Industry** | Business sector of current employer (Technology, Healthcare, Finance, etc.) |
| **Recently Changed Jobs** | Contacts who have recently switched roles or companies |
| **Posted on LinkedIn** | Contacts actively engaging on LinkedIn through recent posts |
...
| Filter | Description |
|--------|-------------|
| **Region** | Geographic location of company headquarters (cities, states, countries, regions) |
| **Company Headcount** | Total employee count (1–10, 11–50, 51–200, 201–500, 501–1,000, 1,001–5,000, 5,001–10,000, 10,001+) |
| **Industry** | Business sector or market vertical (Technology, Healthcare, Finance, etc.) |
| **Annual Revenue** | Revenue ranges in various currencies (USD, EUR, GBP, etc.). Values are expressed in millions |
| **Department Headcount** | Number of employees in specific departments (Accounting, Engineering, Sales, Marketing, etc.) |
| **Job Opportunities** | Companies that have active job postings |
| **Account Activities** | Companies with recent LinkedIn activity signals (Senior leadership changes, Funding events in past 12 months) |
...
|------|-------------|---------|
| **Recently Promoted** | Contacts who recently changed roles in your target market | "Revenue operations professionals who recently changed roles in Spain" |
| **Past Alumni** | Alumni from specific institutions with potential connection value | "Alumni from [University] in leadership positions" |
| **Leadership Experience** | Executives with specific professional backgrounds | "Tech CEOs and founders with sales operations backgrounds" |
| **From Existing Clients** | Decision makers at organizations you already work with | "Decision makers at [Company]'s current client organizations" |
| **AI Contact Discovery** | Contacts matching your ICP in strategic locations | "Spanish-speaking revenue operations professionals in major tech hubs" |
| **ICP-Aligned Companies** | Organizations matching your Ideal Customer Profile with buying signals | "Financial services companies with growth signals" or "Marketing agencies with active hiring signals" |
| **AI Company Discovery** | High-potential companies showing expansion indicators | "High-growth technology companies showing funding or expansion indicators" |
